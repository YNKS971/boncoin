...
<main>
  <div class="test">
    ...
    <form action=" " method="POST" novalidate>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">E-mail ou pseudo*</label>
        <input
          type="text"
          class="form-control"
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
      <a class="btn btn-warning text-white" name="inscrip" href="/inscription" role="button">
        S'INSCRIRE
      </a>
    </div>
  </div>
