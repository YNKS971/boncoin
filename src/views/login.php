...
<body>
    ...
    <form action="/login.php" method="POST" novalidate>
      <div class="mb-3">
        ...
        <input
          type="text" class="form-control" id="exampleFormControlInput1"  name="email" placeholder="exemple.exemple@gmail.com"autocomplete="username" required  value="<?= $_POST["email"] ?? "" ?>">
       
      </div>

      <div class="mb-3 row">
        <label for="inputPassword" class="col-sm-2 col-form-label">Password</label> <span class="ms-2 text-danger fst-italic fw-light"><?= $errors["password"] ?? '' ?></span> 
        <div class="col-sm-10">
          <input
            type="password" class="form-control"id="inputPassword"name="password" value="<?= $_POST["password"] ?? "" ?>">
      ...
      <div class="d-grid gap-2 col-6 mx-auto">
        <input class="btn btn-outline-success" type="submit" value="Se Connecter">
      </div>
    </form>
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
      <a class="btn btn-warning text-white" name="inscrip" href="index.php?url=register" role="button">
        S'INSCRIRE
      </a>
    </div>
  </div>
